...
useDetectScroll.propTypes = {
  thr: propTypesExports.number,
  axis: propTypesExports.string,
  scrollUp: propTypesExports.string,
  scrollDown: propTypesExports.string,
  still: propTypesExports.string,
};
